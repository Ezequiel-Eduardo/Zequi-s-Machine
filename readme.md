...
![GitHub forks](https://img.shields.io/github/forks/Ezequiel-Eduardo/Zequi-s-Machine?style=for-the-badge)
...
## ☕ Usando a Zequi's Machine

Para utilizar a **Zequi's Machine**, siga estas etapas:

1. Clone este repositório em sua máquina:

```bash
git clone https://github.com/Ezequiel-Eduardo/Zequi-s-Machine.git
```
